...
openssl x509 -req -days 400 -in mock-data-holder.csr -CA ..\mtls\ca.pem -CAkey ..\mtls\ca.key -CAcreateserial -out mock-data-holder.pem -extfile mock-data-holder.ext
