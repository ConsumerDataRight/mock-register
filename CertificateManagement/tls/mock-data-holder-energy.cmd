...
openssl x509 -req -days 400 -in mock-data-holder-energy.csr -CA ..\mtls\ca.pem -CAkey ..\mtls\ca.key -CAcreateserial -out mock-data-holder-energy.pem -extfile mock-data-holder-energy.ext
