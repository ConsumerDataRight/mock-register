...
openssl x509 -req -days 1826 -in mock-data-recipient.csr -CA ..\mtls\ca.pem -CAkey ..\mtls\ca.key -CAcreateserial -out mock-data-recipient.pem -extfile mock-data-recipient.ext
