...
namespace CDR.Register.Repository
{
    public class RegisterIdSvrRepository : IRegisterIdSvrRepository
    {
        ...
        public async Task<SoftwareProductIdSvr> GetSoftwareProductAsync(Guid id)
        {
