...
namespace CDR.Register.Repository.Infrastructure
{
    public class MappingProfile : Profile
    {
        ...
        {
            this.CreateMap<LegalEntity, DomainEntities.DataHolderLegalEntity>()
            ...
            this.CreateMap<DomainEntities.DataHolderLegalEntity, LegalEntity>()
            ...
            this.CreateMap<LegalEntity, DomainEntities.DataRecipientLegalEntity>()
                .ForMember(dest => dest.OrganisationType, source => source.MapFrom(source => source.OrganisationType.OrganisationTypeCode))
                .ForMember(dest => dest.Status, source => source.MapFrom(source => source.Participations.FirstOrDefault().Status.ParticipationStatusCode.ToUpper()))
                .MaxDepth(Constants.MappingConstants.MaxDepth);

            this.CreateMap<DomainEntities.DataRecipientLegalEntity, LegalEntity>()
            ...
            this.CreateMap<Participation, DomainEntities.DataHolder>()
                ...
                .MaxDepth(Constants.MappingConstants.MaxDepth);
            this.CreateMap<DomainEntities.DataHolder, Participation>()
                .ForMember(dest => dest.StatusId, source => source.MapFrom(source => Enum.Parse(typeof(ParticipationStatusType), source.Status, true)))
                .ForMember(dest => dest.IndustryId, source => source.MapFrom(source => EnumExtensions.ParseFromDescription<Industry>(source.Industry)))
            ...
            this.CreateMap<Participation, DomainEntities.DataRecipient>()
            ...
            this.CreateMap<Participation, DomainEntities.DataHolderLegalEntity>()
                .ForMember(dest => dest.Status, source => source.MapFrom(source => source.StatusId.ToString().ToUpper()))
                .MaxDepth(Constants.MappingConstants.MaxDepth)
                .ReverseMap();

            this.CreateMap<Brand, DomainEntities.DataHolderBrand>()
                ...
                .MaxDepth(Constants.MappingConstants.MaxDepth);
            this.CreateMap<DomainEntities.DataHolderBrand, Brand>()
            ...
            this.CreateMap<Brand, DomainEntities.DataRecipientBrand>()
                .ForMember(dest => dest.BrandStatus, source => source.MapFrom(source => source.BrandStatus.BrandStatusCode))
                .ForMember(dest => dest.IsActive, source => source.MapFrom(source => source.BrandStatus.BrandStatusId == BrandStatusType.Active))
            ...
            this.CreateMap<DomainEntities.DataRecipientBrand, Brand>()
                .ForMember(dest => dest.BrandStatusId, source => source.MapFrom(source => Enum.Parse(typeof(BrandStatusType), source.BrandStatus, true)))
                .ForMember(dest => dest.BrandStatus, opts => opts.Ignore())
                .ForMember(dest => dest.SoftwareProducts, opts => opts.Ignore())
                .MaxDepth(Constants.MappingConstants.MaxDepth);

            this.CreateMap<SoftwareProduct, DomainEntities.SoftwareProduct>()
            ...
            this.CreateMap<DomainEntities.SoftwareProduct, SoftwareProduct>()
            ...
            this.CreateMap<SoftwareProduct, DomainEntities.SoftwareProductInfosec>()
            ...
            this.CreateMap<SoftwareProductCertificate, DomainEntities.SoftwareProductCertificateInfosec>().ReverseMap().MaxDepth(Constants.MappingConstants.MaxDepth);

            this.CreateMap<AuthDetail, DomainEntities.DataHolderAuthentication>()
                .ForMember(dest => dest.RegisterUType, source => source.MapFrom(source => source.RegisterUType.RegisterUTypeCode))
                .MaxDepth(Constants.MappingConstants.MaxDepth);
            this.CreateMap<DomainEntities.DataHolderAuthentication, AuthDetail>()
            ...
            this.CreateMap<Endpoint, DomainEntities.DataHolderBrandServiceEndpoint>()
                .ReverseMap()
                .MaxDepth(Constants.MappingConstants.MaxDepth);
        }
    }
