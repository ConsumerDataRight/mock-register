...
namespace CDR.Register.IntegrationTests.Miscellaneous
{
    ...
    /// </summary>   
    public class RegisterEnrolment_Tests : BaseTest
    {
        /// <summary>
        ...
        [Fact]
        public async Task Get_ShouldRespondWith_200OK_RepositoryAsJson()
        {
            // Arrange
        ...
        [Fact]
        public async Task Post_WithEmptyRequestBody_ShouldRespondWith_400BadRequest()
        {
            // Arrange
        ...
        [Fact]
        public async Task Post_WithEmptyJson_ShouldRespondWith_400BadRequest()
        {
            // Arrange
        ...
        [Fact]
        public async Task Post_WithInvalidJson_ShouldRespondWith_400BadRequest()
        {
            // Arrange
        ...
        [Fact]
        public async Task Post_WithValidJson_ThenGet_ShouldRespondWith_200OK_ReturnedJsonMatchesPostedJson()
        {
            // Arrange
            //var json = await File.ReadAllTextAsync("data//seed-data-simple.json");
            var json = await File.ReadAllTextAsync(SEEDDATA_FILENAME);
            var jToken = JToken.Parse(json);
        ...
        [Fact]
        public async Task Get_ThenPostUpdatedData_ShouldRespondWith_200OK_ReturnedJsonMatchesPostedJson()
        {
